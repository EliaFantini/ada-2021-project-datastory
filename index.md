...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/wordcloud_all.png"><img style="width:75%" src="/ada-2021-project-datastory/figures/wordcloud_all.png"/></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/wordcloud_comparison.png"><img style="width:100%" src="/ada-2021-project-datastory/figures/wordcloud_comparison.png"></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/topic-frequency-by-party.png"><img style="width:90%" src="/ada-2021-project-datastory/figures/topic-frequency-by-party.png"/></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/topic-per-year.png"><img style="width:100%" src="/ada-2021-project-datastory/figures/topics-per-year.png"/></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/Sentiment per topic (RoBERTa).png"><img style="width:100%" src="/ada-2021-project-datastory/figures/Sentiment per topic (RoBERTa).png" /></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/words_length_dist-1.png"><img style="width:80%" src="/ada-2021-project-datastory/figures/words_length_dist-1.png"/></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/complexity_metrics_14-1.png"><img style="width:80%" src="/ada-2021-project-datastory/figures/complexity_metrics_14-1.png"/></a></div>
...
<div style="text-align:center"><a href="/ada-2021-project-datastory/figures/pew3.png"><img style="width:80%" src="/ada-2021-project-datastory/figures/pew3.png"/></a></div>
...
The final answer is, therefore, yes:  from just a bunch of words, simply by understanding the topic you’re talking about, your sentiment on it, and the way you’re expressing yourself one can predict with a better than random accuracy if you’re a supporter of Democratic or Republican party! It is worth noting, that the accuracy is still not very high, but considering that we built a simple neural network only based on features concerning complexity, sentiment and topics discussed the room for improvement is huge. One could for example build a text-classification pipeline using the textual features of the quotation and a state-of-the-art deep learning model, which would definitely improve the performance, but unfortunately, it is out of the scope of this data story. 
